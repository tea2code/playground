class Rk4:
    ...
    @staticmethod
    def integrate( x, h, state, func, derivateClass ):
        ...
        func -- The function to integrate. This function must take x, h, state and derivate as parameters. Must return the derivate.
        
        Returns the new state.
        """
        k1 = func( x, 0, state, derivateClass() )
